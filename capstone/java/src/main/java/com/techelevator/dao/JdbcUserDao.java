...
//    }
    ...
    @Override
    public void updateRole(int applicationId, String newRole) {
        String sql = "UPDATE users SET role = ? WHERE application_id = ?";
        jdbcTemplate.update(sql, newRole, applicationId);
    }
